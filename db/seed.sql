...
--   email:    super@caser.example.com
--   password: SuperAdmin123!

INSERT INTO `identities` (`name`, `email`, `password_hash`, `is_super_admin`, `token_version`)
VALUES ('Caser Platform', 'super@caser.example.com', '$2b$12$TpdDukTokhNQO5.FqX0oN.SfB0AdAFVsz/pJGGsH6Hhn8MictIIaW', 1, 0);
...
--   office_manager: office_manager@caser.example.com / OfficeManager123!
--   client:         client@caser.example.com / Client123!
...
INSERT INTO `identities` (`name`, `email`, `password_hash`, `is_super_admin`, `token_version`)
VALUES ('Noa Manager', 'office_manager@caser.example.com', '$2b$12$6Heq4eXhPDuPoTzUA4/GvuZKQB7tyWUAGxWPjPW6Y3lUwn5YKy1ym', 0, 0);

INSERT INTO `identities` (`name`, `email`, `password_hash`, `is_super_admin`, `token_version`)
VALUES ('Dor Client', 'client@caser.example.com', '$2b$12$UXr596NctaimScUXL7F.h.vhr/TVTxQggE9lnhR.T1XmFBk7iB0pm', 0, 0);

INSERT INTO `memberships` (`identity_id`, `tenant_id`, `role`, `show_on_public_page`, `active`)
VALUES (
  (SELECT id FROM `identities` WHERE `email` = 'office_manager@caser.example.com'),
...
INSERT INTO `memberships` (`identity_id`, `tenant_id`, `role`, `show_on_public_page`, `active`)
VALUES (
  (SELECT id FROM `identities` WHERE `email` = 'client@caser.example.com'),
  (SELECT id FROM `tenants` WHERE `subdomain` = 'demo'),
  'CLIENT', 0, 1
);

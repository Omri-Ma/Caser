...
# Migrations run on the host machine, not inside Docker, so we need the
# "localhost"-reachable DB URL rather than the container-to-container one
# the app itself uses (which points at hostname "db").

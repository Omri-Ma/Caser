// Auth-aware fetch wrapper for client_api. Base URL reuses the browser's own
...
// redirectOn401 is false for login/register calls themselves — a 401 there
// is "wrong password", a normal inline form error, not an expired session.

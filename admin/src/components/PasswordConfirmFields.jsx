...
// reset-password, signup) — a re-type-to-confirm field catches typos before
// submission. passwordsValid() is exported too, so each page's submit
// button can be gated on the same "long enough and matches" check this
